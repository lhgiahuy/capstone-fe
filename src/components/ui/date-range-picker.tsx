...
>(
  (
    ...
    const [, setSelectedRange] = React.useState<string | null>(
        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
          <PopoverTrigger asChild>
            ...
            >
              ...
              {date.to && date.from ? (
                <p>
                  {formatDate(date.from.toISOString(), "P")} -{" "}
                  {formatDate(date.to.toISOString(), "P")}
                </p>
              ) : (
                <span>Chọn ngày</span>
              )}
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-4">
                    <div className="flex gap-2 ml-3">
                      ...
                      >
                        <SelectTrigger className="hidden sm:flex w-[120px] focus:ring-0 focus:ring-offset-0 font-medium hover:bg-accent hover:text-accent-foreground">
                  ...
                  <div className="flex">
                    <Calendar
                      ...
                      classNames={{
                        caption: "hidden",
                        months:
                          "flex flex-col sm:flex-row space-y-4 sm:space-x-12 sm:space-y-0",
                      }}
